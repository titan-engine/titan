...
use Titan\Area;
use Titan\Character;
use Titan\Http\Requests\CreateUpdateAreaRequest;
use Titan\Stat;
...
class AreaController extends Controller
{
    ...
    {
        return view('titan::titan::admin.areas.index');
    }
    ...
    {
        return view('titan::titan::admin.areas.create');
    }
    ...
    {
        return view('titan::titan::admin.areas.edit', compact('area'));
    }
