...
use Titan\Http\Requests\BannedUserRequest;
...
class BanUserController extends Controller
{
    ...
    {
        $playable = User::all();
        return view('titan::titan::admin.ban.user.create', compact('playable'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('titan::titan::admin.ban.user.edit', compact('banned'));
    }
