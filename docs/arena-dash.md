...
The arena dash is implemented and accepted by the maintainer after playtesting. The
...
The maintainer subsequently accepted playability, with difficulty settings suggested
