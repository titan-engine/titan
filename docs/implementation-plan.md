...
[async capture](inspection.md#asynchronous-capture-contract) contracts distinguish implemented CPU 3D primitives and low-level GPU drawing
from selected player/capture design; they do not grant approval of implementation issues.
