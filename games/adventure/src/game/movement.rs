...
pub(crate) const fn solid(name: &'static str, min: (i32, i32, i32), max: (i32, i32, i32)) -> Solid {
    Solid {
        name,
        min: Position {
            x: min.0,
...
pub const SOLIDS: [Solid; 8] = [
    ...
    solid("partition-north", (7000, 0, 0), (8000, 4000, 4000)),
    solid("partition-south", (7000, 0, 6000), (8000, 4000, 8000)),
];
